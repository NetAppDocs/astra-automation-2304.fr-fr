...
NOTE: Il n'y a pas de nouveaux problèmes connus avec la version 23.06 de l'API REST d'Astra Control. Cette version de l'API est utilisée avec Astra Control Center 23.04 et Astra Control Service 23.06. Tout problème décrit ci-dessous a été découvert dans les versions précédentes et s'applique toujours à la version actuelle.
...
* https://docs.netapp.com/us-en/astra-control-center-2304/release-notes/known-issues.html["Problèmes connus du centre de contrôle Astra"^]
